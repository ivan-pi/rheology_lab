...
file1 = 'S1XantanP1T20.csv'
file2 = 'S1XantanP1T30.csv'
...
for i in range(1,N2+1):
    gstr = 'g'+str(i)
    lstr = 'l'+str(i)
    par2.add(gstr,value=1,min=1.e-7)
    par2.add(lstr,value=1,min=1.e-7)
...
plt.legend(handles=[blue_patch,red_patch,g1_line,g2_line],loc='lower right',fontsize='14')
...
plt.plot(l1,g1,'bo-',
         l2,g2,'ro-')
plt.legend(('Xantan 1.0 %, 20 $^\circ$C', 'Xantan 1.0 %, 30 $^\circ$C'))
